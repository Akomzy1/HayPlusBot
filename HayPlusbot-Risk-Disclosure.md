...
HayPlusbot is a strategy provider on HFM's HFcopy copy-trading platform. If you choose to subscribe to our strategy, HFM will automatically mirror our master account's trades into your HFM account. This is a substantive copy-trading relationship, not passive education — you'll be putting real money at real risk based on trades we decide to take.

Before you can access any performance data, signal history, or subscribe to the strategy, we need you to read and understand what you're signing up for. This usually takes 8-10 minutes. Please don't skim.

You'll tick three acknowledgment boxes at the end. Your signing — name, email, country, IP address, timestamp, and a cryptographic hash of this document — will be stored as your informed consent record, and you'll receive a PDF copy by email.
...
### What HayPlusbot is responsible for

**Running the strategy as described.** Our master account behaves according to the methodology we publish. If we make changes to the strategy, we communicate them. If the strategy deviates from what we've publicly stated, that's our failure to address.

**Honest performance reporting.** Every number on our website reflects actual, unfiltered master account performance. We don't inflate returns, hide losing months, or cherry-pick time windows. If performance declines, our dashboards reflect it.

**Transparent methodology.** Our complete methodology — the SMC/ICT A+ criteria, fundamental filters, session windows, circuit breakers — is documented on our "How it works" page.

**Data security.** We hold minimal personal data — email, country, signing record. We follow Nigerian Data Protection Regulation (NDPR) and GDPR standards where applicable. We never hold your MT5 credentials (we don't need them), we never hold your funds, and we don't sell your data.

**Operational care.** We make reasonable efforts to keep the master account running during market sessions and to respond to incidents promptly. We do not guarantee uptime but we communicate honestly when disruptions happen.

**Support.** We respond to legitimate enquiries at hello@hayplusbot.com within 72 hours.

### What you are responsible for

**Your HFM account.** Your credentials, your deposits, your withdrawals, your copy-trading configuration (copy ratio, leverage, maximum drawdown). Any activity in your HFM account — including copied trades from our strategy — is your account and your responsibility.

**Your subscription decisions.** Deciding whether to subscribe. Deciding when to unsubscribe. Deciding whether to increase or decrease your copy ratio. HFM's interface gives you all these controls; using them correctly is your responsibility.

**Your suitability assessment.** Deciding whether copy trading our strategy is appropriate for your personal financial situation.

**Your tax obligations.** Gains and losses from your HFM account are yours to report. We provide performance history on the master account; you're responsible for calculating your own results and filing your own taxes. We do not provide tax advice.

**Legal compliance in your jurisdiction.** Ensuring that using HFM, subscribing to copy-trading services, and trading forex are legal where you live. Some jurisdictions restrict copy trading; it is your responsibility to comply with any such restrictions.

**Monitoring your HFM account.** Copy trading is automated but not "fire and forget." Review your HFM account regularly.

### What neither of us controls
...
**Performance fee — our primary revenue.** HFM deducts a performance fee from the profits on trades copied from our strategy into your account. The specific fee percentage is displayed in HFM's HFcopy subscription interface when you subscribe — you must review and accept those terms on HFM's platform before your subscription activates. No fee on losses. No monthly fee. No fixed charge.
...
### Box 2 — Relationship acknowledgment
...
### Box 3 — Responsibility acknowledgment
...
### With our strategy
If you believe the master account is behaving outside our documented methodology, email hello@hayplusbot.com. We'll review the audit logs — every signal fire, every trade, every filter decision — and share the relevant trace with you.

### With HFM's mirroring
If you have concerns about how HFM is copying trades into your account, subscription fees, platform availability, KYC questions, withdrawals, or anything else happening inside HFM's platform — contact HFM support directly. We have no access to your account and cannot adjust HFM's systems on your behalf.

### Our liability limits
HayPlusbot's liability for any claim arising from your use of our service is limited to direct demonstrable losses caused by our gross negligence or wilful misconduct. Because we do not hold your funds, do not process payments, and do not execute trades on your account, most failure modes are outside our direct control.

We do not offer refunds — there is nothing paid to us to refund.

We do not compensate for trading losses from market conditions, HFM platform issues, or your configuration choices.

Nothing in this section overrides non-excludable statutory rights you have as a consumer under Nigerian law, English law (for UK subscribers), or similar consumer protection frameworks in your jurisdiction.

---

## Part 7 — Jurisdiction and governing law

This acknowledgment and your relationship with HayPlusbot are governed by the laws of the Federal Republic of Nigeria. Disputes not resolved through good-faith discussion are subject to the exclusive jurisdiction of the courts of Lagos State.

Your relationship with HFM is separately governed by HFM's terms. HFM's jurisdiction clauses take precedence for matters involving HFM's platform (subscriptions, fees, mirroring, withdrawals, account operations).

If you're subscribing from a jurisdiction with non-excludable consumer rights (UK, EU, or similar), those rights apply in addition to this agreement.

---

## Part 8 — Changes to this disclosure

We may update this document over time. When material changes happen, we'll email existing subscribers and ask them to re-acknowledge before continuing to receive copied trades.

Minor changes — clarifications, formatting, typo fixes — are timestamped in a version history but don't require re-acknowledgment.

---

## Part 9 — Getting help

For any questions about this disclosure or about HayPlusbot, contact **hello@hayplusbot.com**.

For anything involving your HFM account — subscribing, unsubscribing, deposits, withdrawals, fee questions, KYC, complaints about HFM's service — contact HFM directly through their support channels.

---

**Signing details (filled in automatically):**
...
A PDF copy of this signed acknowledgment will be emailed to you immediately upon completion. Keep it.
